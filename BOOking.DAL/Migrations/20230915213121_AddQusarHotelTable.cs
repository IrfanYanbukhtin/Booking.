...
{
    public partial class AddQusarHotelTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QusarHotels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QusarHotels_Explores_ExploreId",
