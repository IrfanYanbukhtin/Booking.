...
{
    public partial class GanjaHotelTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GanjaHotels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GanjaHotels_Explores_ExploreId",
