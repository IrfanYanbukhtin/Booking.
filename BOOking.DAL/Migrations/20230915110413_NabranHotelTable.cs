...
{
    public partial class NabranHotelTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NabranHotels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NabranHotels_Explores_ExploreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NabranHotels_ExploreId",
                table: "NabranHotels",
                column: "ExploreId");
        }
